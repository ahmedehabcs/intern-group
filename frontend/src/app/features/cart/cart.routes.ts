...
export const CART_ROUTES: Routes = [{ path: '', canActivate:[authGuard,roleGuard],data:{roles:['CUSTOMER']},loadComponent:()=>import('./pages/cart-page/cart-page').then(m=>m.CartPage) }];
