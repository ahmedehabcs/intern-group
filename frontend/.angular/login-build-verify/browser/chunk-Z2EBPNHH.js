import { ActivatedRoute, Router } from './chunk-TBWUJ4NH.js';
import { FormsModule, NgControlStatusGroup, NgForm, ɵNgNoValidate } from './chunk-PU67HFL7.js';
import {
  CommonModule,
  Component,
  ViewChildren,
...
var OtpVerification = class _OtpVerification {
  ...
  static ɵcmp = /* @__PURE__ */ ɵɵdefineComponent({
    ...
    viewQuery: function OtpVerification_Query(rf, ctx) {
      if (rf & 1) {
        ɵɵviewQuery(_c0, 5);
      }
      if (rf & 2) {
    ...
    consts: [
      ['otpInput', ''],
      [1, 'auth-page', 'otp-page'],
      [1, 'otp-card', 3, 'ngSubmit'],
      [1, 'otp-icon'],
      ['viewBox', '0 0 24 24'],
      ['d', 'M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10Z'],
      ['x', '8.5', 'y', '10', 'width', '7', 'height', '6', 'rx', '1'],
      ['d', 'M10 10V8.5a2 2 0 0 1 4 0V10'],
      [1, 'auth-heading'],
      [1, 'auth-copy'],
      [1, 'otp-inputs'],
      ['type', 'text', 'inputmode', 'numeric', 'maxlength', '1', 3, 'value'],
      [1, 'timer'],
      [1, 'resend'],
      ['type', 'button', 3, 'disabled'],
      ['type', 'submit', 1, 'primary-btn', 'verify-button'],
      [1, 'secure'],
      ['type', 'text', 'inputmode', 'numeric', 'maxlength', '1', 3, 'input', 'keydown', 'value'],
    ],
    template: function OtpVerification_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵrepeaterCreate(
          17,
          OtpVerification_For_18_Template,
          2,
          2,
          'input',
          11,
    ...
    dependencies: [CommonModule, FormsModule, ɵNgNoValidate, NgControlStatusGroup, NgForm],
    styles: [
          ...
          args: [
            {
              ...
              template: `<div class="auth-page otp-page">\r
...
(() => {
  (typeof ngDevMode === 'undefined' || ngDevMode) &&
    ɵsetClassDebugInfo(OtpVerification, {
      className: 'OtpVerification',
      filePath: 'src/app/features/auth/pages/otp-verification/otp-verification.ts',
      lineNumber: 12,
    });
})();
