import { RouterOutlet, bootstrapApplication, provideRouter } from './chunk-TBWUJ4NH.js';
import {
  Component,
...
var routes = [
  ...
  {
    path: '',
    loadComponent: () => import('./chunk-SLJ47VHG.js').then(({ CustomerLayout }) => CustomerLayout),
    children: [
      {
        path: '',
      ...
      },
      {
        path: 'restaurants',
        loadChildren: () =>
          import('./chunk-YGGEPVUH.js').then(({ RESTAURANTS_ROUTES }) => RESTAURANTS_ROUTES),
      },
      {
        path: 'search',
        loadChildren: () =>
          import('./chunk-SRVAVBRZ.js').then(({ SEARCH_ROUTES }) => SEARCH_ROUTES),
      },
      {
        path: 'orders',
        loadChildren: () =>
          import('./chunk-ORNEIPZU.js').then(({ ORDERS_ROUTES }) => ORDERS_ROUTES),
      },
      {
        path: 'account',
        loadChildren: () =>
          import('./chunk-23JSYKTU.js').then(({ ACCOUNT_ROUTES }) => ACCOUNT_ROUTES),
      },
    ],
  },
  {
    path: '',
    loadComponent: () => import('./chunk-BNKATLIU.js').then(({ CheckoutLayout }) => CheckoutLayout),
    children: [
      {
        path: 'cart',
      ...
      },
      {
        path: 'checkout',
        loadChildren: () =>
          import('./chunk-OIVS26SY.js').then(({ CHECKOUT_ROUTES }) => CHECKOUT_ROUTES),
      },
    ],
  },
  {
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./chunk-BM7B2N4K.js').then(({ RestaurantLayout }) => RestaurantLayout),
    loadChildren: () =>
      import('./chunk-S6K5XVDW.js').then(
...
var App = class _App {
  ...
  static ɵcmp = /* @__PURE__ */ ɵɵdefineComponent({
    type: _App,
    selectors: [['app-root']],
    hostAttrs: [1, 'block', 'w-full', 'overflow-x-clip'],
    decls: 1,
    vars: 0,
...
(() => {
  (typeof ngDevMode === 'undefined' || ngDevMode) &&
    ɵsetClassDebugInfo(App, { className: 'App', filePath: 'src/app/app.ts', lineNumber: 12 });
})();
