...
var Home = class _Home {
  ...
  products = [
    ...
    },
    {
      ...
      store: 'artisan',
      name: 'Truffle Funghi',
      description: 'Wild mushrooms, mozzarella, parmesan, truffle oil',
      price: 16500,
      position: '13% 71%',
    },
    {
      ...
      description: 'Beef pepperoni, hot honey, mozzarella',
      price: 15e3,
      position: '20% 73%',
    },
    {
      id: 's1',
      store: 'oishii',
      name: 'Oishii Signature Set',
      description: 'Salmon, tuna, shrimp nigiri and maki selection',
      price: 22e3,
      position: '96% 72%',
    },
    {
      ...
      store: 'oishii',
      name: 'Salmon Lover',
      description: 'Fresh salmon nigiri, sashimi and avocado roll',
      price: 18500,
      position: '92% 69%',
    },
    {
      ...
      description: 'Chargrilled beef, cheddar, pickles, house sauce',
      price: 13500,
      position: '52% 67%',
    },
    {
      ...
      store: 'oak',
      name: 'Truffle Smash',
      description: 'Double beef, caramelized onions and truffle aioli',
      price: 15500,
      position: '54% 69%',
    },
    {
      ...
      store: 'fresh',
      name: 'Farm Fresh Box',
      description: 'A seasonal selection of fruit and vegetables',
      price: 18e3,
      position: '3% 27%',
    },
    {
      ...
      description: 'Fresh pantry staples for your kitchen',
      price: 26e3,
      position: '10% 28%',
    },
    {
      ...
      description: 'Vanilla cream, mixed berries and almond crumb',
      price: 28e3,
      position: '36% 31%',
    },
    {
      ...
      store: 'bliss',
      name: 'Mini Cake Box',
      description: 'Four handcrafted seasonal mini cakes',
      price: 19500,
      position: '39% 31%',
    },
    {
      ...
      description: 'Greens, cucumber, tomato, grains and lemon dressing',
      price: 11e3,
      position: '68% 30%',
    },
    {
      ...
      description: 'Chicken, greens, seasonal vegetables and seeds',
      price: 13500,
      position: '70% 29%',
    },
  ];
  ...
  static ɵcmp = /* @__PURE__ */ ɵɵdefineComponent({
    ...
    consts: [
      ...
      ['cx', '11', 'cy', '11', 'r', '7'],
      ['d', 'm20 20-4-4'],
      ['type', 'search', 'placeholder', 'Search dishes', 3, 'input'],
      ['d', 'M4 7h10M18 7h2M4 17h2m4 0h10M8 4v6m8 4v6'],
      [1, 'browse-section', 'categories-section'],
      [1, 'section-heading'],
      [1, 'step-label'],
      [1, 'section-count'],
      [1, 'category-grid'],
      ['type', 'button', 1, 'category-card', 3, 'active'],
      [1, 'browse-section'],
      [1, 'store-grid'],
      ['type', 'button', 1, 'store-card', 3, 'active'],
      ['id', 'products', 1, 'browse-section', 'products-section'],
      [1, 'product-grid'],
      [1, 'product-card'],
      [1, 'empty-state'],
      ['aria-label', 'Mobile navigation', 1, 'mobile-nav'],
      ['routerLink', '/', 1, 'active'],
      ['viewBox', '0 0 24 24'],
      ['d', 'm3 11 9-8 9 8v9h-6v-6H9v6H3Z'],
      ['routerLink', '/search'],
      ['type', 'button'],
      ...
      ['type', 'button', 1, 'category-card', 3, 'click'],
      ['role', 'img', 1, 'card-photo'],
      [1, 'category-copy'],
      ['aria-hidden', 'true', 1, 'selected-dot'],
      ['type', 'button', 1, 'store-card', 3, 'click'],
      [1, 'store-photo'],
      [1, 'rating'],
      [1, 'eta'],
      [1, 'store-info'],
    ...
    dependencies: [CommonModule, RouterLink, DecimalPipe],
    styles: [
...
(() => {
  (typeof ngDevMode === 'undefined' || ngDevMode) &&
    ɵsetClassDebugInfo(Home, {
      className: 'Home',
      filePath: 'src/app/features/home/pages/home/home.ts',
      lineNumber: 38,
    });
})();
export { Home };
