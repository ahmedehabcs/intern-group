...
class CategoryServiceImplTests {
    ...
    @Test
    void browseWithoutSearchReturnsAllActiveCuisineCategories() {
        ...
        List<CategoryResponse> result = categoryService.browseCategories(null);
    ...
    void blankSearchIsTreatedAsNoSearch() {
        ...
        categoryService.browseCategories("   ");

        verify(categoryRepository).findDistinctByIsActiveTrueAndRestaurants_IsActiveTrueOrderByNameAsc();
    }

    @Test
    void categorySearchIsTrimmedAndDelegatedToTheCuisineNameQuery() {
        Category chinese = category(2L, "Chinese", null);
        when(categoryRepository
                .findDistinctByIsActiveTrueAndRestaurants_IsActiveTrueAndNameContainingIgnoreCaseOrderByNameAsc("chi"))
                .thenReturn(List.of(chinese));

        List<CategoryResponse> result = categoryService.browseCategories("  chi  ");
