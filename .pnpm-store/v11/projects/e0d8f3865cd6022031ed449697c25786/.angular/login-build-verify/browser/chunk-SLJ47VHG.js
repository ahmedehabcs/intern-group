...
var Navbar = class _Navbar {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Navbar, selectors: [["app-navbar"]], decls: 35, vars: 3, consts: [[1, "site-header"], ["routerLink", "/", "aria-label", "Talabaty home", 1, "brand"], [1, "brand-mark"], ["type", "button", 1, "location"], ["viewBox", "0 0 24 24", "aria-hidden", "true"], ["d", "M20 10c0 5-8 12-8 12S4 15 4 10a8 8 0 1 1 16 0Z"], ["cx", "12", "cy", "10", "r", "2.5"], ["d", "m8 10 4 4 4-4"], ["routerLink", "/search", "aria-label", "Open search", 1, "nav-search"], ["cx", "11", "cy", "11", "r", "7"], ["d", "m20 20-4-4"], ["type", "button", 1, "nav-theme", 3, "click", "title"], [1, "nav-actions"], ["routerLink", "/auth/login", 1, "login-link"], ["type", "button", "aria-label", "Open cart", 1, "cart-button"], ["d", "M3 4h2l2.3 10.1a2 2 0 0 0 2 1.5h7.9a2 2 0 0 0 2-1.6L21 7H6"], ["cx", "10", "cy", "20", "r", "1"], ["cx", "18", "cy", "20", "r", "1"], ["cx", "12", "cy", "12", "r", "4"], ["d", "M12 2v2m0 16v2M4.9 4.9l1.4 1.4m11.4 11.4 1.4 1.4M2 12h2m16 0h2M4.9 19.1l1.4-1.4M17.7 6.3l1.4-1.4"], ["d", "M20.7 15.1A8.5 8.5 0 0 1 8.9 3.3 8.5 8.5 0 1 0 20.7 15.1Z"]], template: function Navbar_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(23, Navbar_Conditional_23_Template, 3, 0, ":svg:svg", 4)(24, Navbar_Conditional_24_Template, 2, 0, ":svg:svg", 4);
      \u0275\u0275elementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Navbar, [{
    type: Component,
    args: [{ selector: "app-navbar", imports: [RouterLink], template: `<header class="site-header">\r
...
`, styles: ['/* src/app/layouts/customer-layout/components/navbar/navbar.css */\n.site-header {\n  position: sticky;\n  z-index: 30;\n  top: 0;\n  height: 78px;\n  display: flex;\n  align-items: center;\n  gap: 28px;\n  padding: 0 max(32px, calc((100vw - 1240px) / 2));\n  border-bottom: 1px solid var(--border);\n  background: color-mix(in srgb, var(--home-bg) 90%, transparent);\n  -webkit-backdrop-filter: blur(16px);\n  backdrop-filter: blur(16px);\n}\n.brand {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  color: var(--brand);\n  font-family: "Playfair Display", serif;\n  font-size: 24px;\n  font-weight: 700;\n}\n.brand-mark {\n  width: 36px;\n  height: 36px;\n  display: grid;\n  place-items: center;\n  border-radius: 11px;\n  background: var(--brand);\n  color: #fff;\n  font-family: "DM Sans", sans-serif;\n  font-size: 18px;\n}\n.location {\n  display: flex;\n  align-items: center;\n  gap: 9px;\n  border: 0;\n  background: transparent;\n  color: var(--text);\n  cursor: pointer;\n  text-align: left;\n}\n.location svg,\n.nav-search svg,\n.cart-button svg {\n  width: 20px;\n  height: 20px;\n  fill: none;\n  stroke: currentColor;\n  stroke-linecap: round;\n  stroke-linejoin: round;\n  stroke-width: 1.8;\n}\n.location > svg:first-child {\n  color: var(--brand);\n}\n.location > svg:last-child {\n  width: 14px;\n}\n.location span {\n  display: grid;\n  font-size: 14px;\n  font-weight: 600;\n}\n.location small {\n  color: var(--text-soft);\n  font-size: 10px;\n  font-weight: 500;\n}\n.nav-search {\n  height: 44px;\n  min-width: 220px;\n  max-width: 400px;\n  flex: 1;\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  padding: 0 15px;\n  border-radius: 13px;\n  background: var(--surface);\n  color: var(--muted);\n}\n.nav-search span {\n  color: var(--muted);\n  font-size: 13px;\n}\n.nav-actions {\n  display: flex;\n  align-items: center;\n  gap: 18px;\n}\n.nav-theme {\n  width: 42px;\n  height: 42px;\n  flex: 0 0 auto;\n  display: grid;\n  place-items: center;\n  border: 1px solid var(--border);\n  border-radius: 50%;\n  background: var(--surface);\n  color: var(--text);\n  box-shadow: var(--shadow-sm);\n  cursor: pointer;\n}\n.nav-theme svg {\n  width: 19px;\n  height: 19px;\n  fill: none;\n  stroke: currentColor;\n  stroke-linecap: round;\n  stroke-linejoin: round;\n  stroke-width: 1.8;\n}\n.login-link {\n  color: var(--brand);\n  font-size: 14px;\n  font-weight: 700;\n}\n.cart-button {\n  position: relative;\n  width: 42px;\n  height: 42px;\n  display: grid;\n  place-items: center;\n  border: 0;\n  border-radius: 13px;\n  background: var(--brand);\n  color: #fff;\n}\n.cart-button span {\n  position: absolute;\n  top: -5px;\n  right: -5px;\n  width: 19px;\n  height: 19px;\n  display: grid;\n  place-items: center;\n  border: 2px solid var(--home-bg);\n  border-radius: 50%;\n  background: var(--text);\n  font-size: 9px;\n}\n@media (max-width: 800px) {\n  .site-header {\n    position: relative;\n    height: 70px;\n    padding: 0 70px 0 18px;\n  }\n  .brand {\n    font-size: 20px;\n  }\n  .brand-mark {\n    width: 33px;\n    height: 33px;\n  }\n  .location,\n  .nav-search,\n  .nav-actions {\n    display: none;\n  }\n  .nav-theme {\n    position: absolute;\n    right: 15px;\n    width: 40px;\n    height: 40px;\n  }\n}\n/*# sourceMappingURL=navbar.css.map */\n'] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Navbar, { className: "Navbar", filePath: "src/app/layouts/customer-layout/components/navbar/navbar.ts", lineNumber: 10 });
})();
...
var CustomerLayout = class _CustomerLayout {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CustomerLayout, selectors: [["app-customer-layout"]], decls: 3, vars: 0, template: function CustomerLayout_Template(rf, ctx) {
    if (rf & 1) {
  ...
  }, dependencies: [Navbar, RouterOutlet], styles: ["\nmain[_ngcontent-%COMP%] {\n  min-height: 100vh;\n}\n/*# sourceMappingURL=customer-layout.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CustomerLayout, [{
    type: Component,
    args: [{ selector: "app-customer-layout", imports: [Navbar, RouterOutlet], template: "<app-navbar />\r\n<main>\r\n  <router-outlet />\r\n</main>\r\n", styles: ["/* src/app/layouts/customer-layout/customer-layout.css */\nmain {\n  min-height: 100vh;\n}\n/*# sourceMappingURL=customer-layout.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CustomerLayout, { className: "CustomerLayout", filePath: "src/app/layouts/customer-layout/customer-layout.ts", lineNumber: 12 });
})();
export {
  CustomerLayout
};
